...
function trimmer(Timcook){
  return Timcook.split("=")[1];
}

function check(){
  value=trimmer(document.cookie);
  return value==MD5(codes);
}

// Reference: https://stackoverflow.com/questions/14733374/how-to-generate-an-md5-file-hash-in-javascript-node-js
